...
@Component({
  selector: 'app-editor-classic',
  standalone: true,
  imports: [BreadcrumbComponent, CommonModule, CKEditorModule, FormsModule],
  templateUrl: './editor-classic.component.html',
  styleUrl: './editor-classic.component.css',
})
export class EditorClassicComponent {
  public Editor = ClassicEditor;
  public editorData: string = `<h2>The three greatest things you learn from traveling</h2>
