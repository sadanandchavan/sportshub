...
@Component({
  selector: 'app-dt-ext-row-reorder',
  standalone: true,
  imports: [
    BreadcrumbComponent,
    CommonModule,
  ...
  templateUrl: './dt-ext-row-reorder.component.html',
  styleUrl: './dt-ext-row-reorder.component.css',
})
export class DtExtRowReorderComponent {
