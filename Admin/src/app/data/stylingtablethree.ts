...
// src/app/data/stylingtablethree.ts
export interface EmployeeThree {
  name: string;
  position: string;
  office: string;
  age: number;
...
export const tableDataThree: EmployeeThree[] = [
  ...
  { name: 'Yuri Mantis', position: 'Chief Marketing Officer (CMO)', office: 'New York', age: 40, startDate: '2009/06/25', salary: '$675,000' },
